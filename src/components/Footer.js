      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div>
            <div className="flex space-x-3 mb-6">
              <button className="p-2 bg-gray-300 hover:bg-gray-400 rounded-full transition">
        ...
        <div className="border-t border-gray-300 pt-6 text-center">
          <p className="text-sm text-gray-600">
            © 2025 Regal. Developed by <a href="https://www.linkedin.com/in/samadaman/" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:text-gray-700 transition">Samad Aman </a>.
          </p>
        </div>
      </div>
    </footer>
