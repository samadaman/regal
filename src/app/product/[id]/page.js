          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              <button
                ...
                className="flex-1 bg-[#2C2416] text-white py-4 px-8 font-medium hover:bg-[#3D3020] transition-colors flex items-center justify-center gap-3"
              >
                {addedToCart ? (
                  <>
              ...
              <button className="border-2 border-[#2C2416] text-[#2C2416] py-4 px-8 font-medium hover:bg-[#2C2416] hover:text-white transition-colors">
                Buy Now
              </button>
            </div>
